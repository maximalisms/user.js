This is my OWN version of arkenfox's user.js configuration for Mozilla Firefox. There are not very many changes from the original, but just enough to fit my individual needs.
